...
After both artifacts exist, immediately validate the new artifacts before completing the stage. The self-check is a combined Stage 0 check; do not run it after only `prd.md` exists.
