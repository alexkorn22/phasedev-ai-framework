...
Final response is allowed only after the self-check passes or the current phase is honestly recorded as `blocked`. It must use this compact template and include no extra sections:
